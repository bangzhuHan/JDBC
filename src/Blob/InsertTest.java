...
public class InsertTest {
    ...
    public  void testInsert1() {
        ...
        try {
            ...
            System.out.println("总时间：" + (end - start));//63116
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public void testInsert2() {
        ...
        try {
            ...
            System.out.println("总时间：" + (end - start));//1000000:16353
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            JDBCUtil.closeResource(connection1, ps);
        }
    }
    ...
    public void testInsert3() {
        ...
        } catch (Exception e) {								//1000000:16086 -- 9489
            e.printStackTrace();
        }finally{
